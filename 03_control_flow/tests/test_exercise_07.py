"""Tests for exercise 07 -- decode a status word with match.
...
# 03_control_flow/tests/, and we want 03_control_flow/ itself.
...
EXERCISE = MODULE / "exercises" / "exercise_07.py"
SOLUTION = MODULE / "solutions" / "solution_07.py"
