"""Tests for exercise 02 -- reading a refusal.

You are meant to read this file: it says exactly what your exercise has to do.

The 422 body is checked field by field, because that is how a client reads it. A
message that only a human can parse would be a worse interface, not a friendlier one.
"""
