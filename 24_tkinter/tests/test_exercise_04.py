"""Tests for exercise 04 -- a StringVar is not a str.

You are meant to read this file: it says exactly what your exercise has to do.

The third expected line is the interesting one. It has three entries for two changes,
and one of them is empty -- which is what an edit looks like from a listener's side.
"""
