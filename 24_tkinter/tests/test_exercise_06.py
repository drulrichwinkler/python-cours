"""Tests for exercise 06 -- the exception nobody sees.

You are meant to read this file: it says exactly what your exercise has to do.

Watch what this test does *not* check: the traceback. It goes to stderr, and
`assert_output` compares stdout, which is precisely the asymmetry the exercise is
about. The exit code of the broken program is 0.
"""
