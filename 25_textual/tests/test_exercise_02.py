"""Tests for exercise 02 -- compose is a generator function.

You are meant to read this file: it says exactly what your exercise has to do.

Two of the four checks need no running app at all -- `inspect.isgeneratorfunction`
and the type of what `compose()` returns are facts about the class.
"""
